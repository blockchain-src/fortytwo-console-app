...
function Auto-Select-Model {
    ...
    if ($AVAILABLE_MEM_INT -ge 16) {
        Animate-Text "Recommended: TELEOLOGY PYLON for high-performance systems"
        $global:LLM_HF_REPO = "bartowski/INTELLECT-1-Instruct-GGUF"
        $global:LLM_HF_MODEL_NAME = "INTELLECT-1-Instruct-Q4_K_M.gguf"
        $global:NODE_NAME = "TELEOLOGY PYLON"
...
Write-Host "|===========================================================================|"
Write-Host "| 6. CUSTOM - Advanced Configuration                                        |"
Write-Host "|===========================================================================|"
Write-Host ""
$NODE_CLASS = Read-Host "Select your node's specialization [0-6] (0 for auto-select)"
